...
export default async function HomePage() {
  ...
  const infraObjekti = infrastruktura.objects;
  const stories = publishedStories.slice(0, 3);
    ...
    <>
      ...
      <section id="price">
        <div className="wrap">
          <div className="section-head">
            <div>
              <span className="idx">07 — Priče</span>
              <h2>Priče i ljudi Čizmića</h2>
            </div>
            <div className="sub">
              Objave mještana nakon odobrenja.{" "}
              <Link href="/price">Sve priče →</Link>
            </div>
          </div>
          <div className="story-grid">
            {stories.length === 0 ? (
              <p>Još nema objavljenih priča.</p>
            ) : (
              stories.map((s) => (
